...
TrainFeatures.data_BuyOrNot_FirstTime.to_csv('TrainFeatures.csv',index=False,header=True)
...
PredFeatures.data_BuyOrNot_FirstTime.to_csv('PredFeatures.csv',index=False,header=True)
